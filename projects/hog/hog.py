...
def get_digit_of_number(number, digit):
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    single_digit, ten_digit = get_digit_of_number(score, 0), get_digit_of_number(score, 1)
    return 10 - single_digit + ten_digit
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 4
    player_single_digit, player_ten_digit = get_digit_of_number(player_score, 0), get_digit_of_number(player_score, 1)
    opponent_single_digit, opponent_ten_digit = get_digit_of_number(opponent_score, 0), get_digit_of_number(opponent_score, 1)
    return abs(player_single_digit - opponent_single_digit) == opponent_ten_digit
